...
class jual :  Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater!!.inflate(R.layout.jual_barang, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
                        ...
                        .addOnCompleteListener { task ->
                            if (task.isSuccessful) {
                                ...
                                for (doc in task.result!!) {
                                    ...
                                    spin.adapter = ArrayAdapter( activity,
        ...
        button4.setOnClickListener {
            var  popmenu=PopupMenu(context,button4)
    ...
    private fun cek() {
        if (barangnama.text.isEmpty()){
            ...
            Toast.makeText(context,"Error Masukan",Toast.LENGTH_LONG).show()
        } else{
    ...
    private fun setdatajual(
        ...
        val intent = Intent(context, kantong::class.java)
    ...
    private fun uploadimage()  {
        ...
        if (filePath != null) {
            ...
            Toast.makeText(context,"Harap masukan gambar",Toast.LENGTH_LONG).show()
            progress.dismiss()
        }
